...
import { callCreateAccount } from "../../api/AccountApi";
import { callGetCustomerNames } from "../../api/CustomerApi";
import { toast } from "sonner";
import { callGetLoanPlans } from "../../api/LoanApi";
...
const CreateLoan = ({ triggerFetchCustomers }) => {
    ...
    const fetchPlans = async () => {
        const plans = await callGetLoanPlans();
        setPlans(plans);
    };
    ...
    return (
        <Form {...form}>
            ...
            >
                <div>
                    <h2 className="text-2xl font-bold">Create Loan Request</h2>
                    <FormDescription>
                        Fill out the form to create a nloan request
                    </FormDescription>
                </div>
