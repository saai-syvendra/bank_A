...
(1, 10004, 150000.00, '2020-09-01', 'saving'),
(1, 10004, 100000.00, '2021-09-02', 'checking'),
(2, 10005, 200000.00, '2019-09-03', 'saving'),
(1, 10006, 180000.00, '2022-09-04', 'checking'),
(1, 10007, 120000.00, '2023-09-05', 'checking'),
(1, 10008, 180000.00, '2023-09-15', 'saving'),
(3, 10008, 1250250.00, '2024-09-15', 'saving'),
(4, 10010, 100000.00, '2024-09-15', 'checking'),
(3, 10009, 100000.00, '2024-09-17', 'checking'),
(4, 10009, 150000.00, '2024-09-18', 'saving');
...
(1, 1500.00, '2022-01-05 08:20:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(1, 3500.00, '2022-01-12 10:40:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(2, 2000.00, '2022-02-03 09:30:00', 'Subscription Fee', 'debit', 'online-transfer'),
(2, 5000.00, '2022-02-10 12:50:00', 'Gift Deposit', 'credit', 'via_employee'),
(3, 1000.00, '2022-03-04 14:15:00', 'ATM Fee', 'debit', 'atm-cdm'),
(3, 4000.00, '2022-03-15 16:20:00', 'Deposit by Employee', 'credit', 'via_employee'),
(4, 3000.00, '2022-04-02 09:45:00', 'Utility Bill Payment', 'debit', 'server'),
(4, 2000.00, '2022-04-12 13:30:00', 'Salary Credit', 'credit', 'server'),
(5, 2500.00, '2022-05-01 08:00:00', 'Grocery Shopping', 'debit', 'via_employee'),
(5, 1000.00, '2022-05-08 14:05:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(6, 3000.00, '2022-06-05 10:50:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(6, 4000.00, '2022-06-10 12:15:00', 'Loan Repayment', 'debit', 'server'),
(7, 1500.00, '2022-07-01 09:30:00', 'Shopping', 'debit', 'online-transfer'),
(7, 6000.00, '2022-07-07 15:45:00', 'Bonus Credit', 'credit', 'server'),
(8, 3500.00, '2022-08-03 16:10:00', 'Loan Repayment', 'debit', 'server'),
(8, 1000.00, '2022-08-12 09:55:00', 'Cashback', 'credit', 'via_employee'),
(9, 4000.00, '2022-09-01 08:40:00', 'Deposit by Employee', 'credit', 'via_employee'),
(9, 2500.00, '2022-09-06 11:20:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
...
(1, 1500.00, '2022-11-12 11:10:00', 'Loan Repayment', 'debit', 'server'),
(2, 200.00, '2022-11-25 12:35:00', 'Bonus Credit', 'credit', 'server'),
(2, 3000.00, '2022-12-01 14:20:00', 'Cash Deposit', 'credit', 'atm-cdm'),
(3, 400.00, '2022-12-05 08:55:00', 'Service Fee', 'debit', 'server'),
(3, 2500.00, '2022-12-08 15:15:00', 'Interest Payment', 'credit', 'server'),
(4, 500.00, '2022-12-12 10:05:00', 'Loan Repayment', 'debit', 'server'),
(4, 6000.00, '2022-12-18 16:45:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(5, 7000.00, '2022-12-20 09:30:00', 'Account Adjustment', 'credit', 'server'),
(6, 4050.00, '2022-12-28 11:55:00', 'Mobile Bill Payment', 'debit', 'via_employee');


-- 2023 Transactions

INSERT INTO Account_Transaction (account_id, amount, trans_timestamp, reason, trans_type, trans_method) VALUES
(1, 2500.00, '2023-01-03 09:15:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(1, 4500.00, '2023-01-10 11:30:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(2, 1205.00, '2023-02-05 10:00:00', 'Service Charge', 'debit', 'server'),
(2, 500.00, '2023-02-08 14:20:00', 'Deposit by Employee', 'credit', 'via_employee'),
(3, 2000.00, '2023-03-03 12:15:00', 'Online Purchase', 'debit', 'online-transfer'),
(3, 750.00, '2023-03-15 16:40:00', 'Gift Deposit', 'credit', 'via_employee'),
(4, 1000.00, '2023-04-01 09:50:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(4, 600.00, '2023-04-05 14:25:00', 'Cashback', 'credit', 'server'),
(5, 400.00, '2023-05-10 10:35:00', 'Bill Payment', 'debit', 'via_employee'),
(5, 1500.00, '2023-05-12 09:05:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(6, 500.00, '2023-06-01 08:20:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(6, 2500.00, '2023-06-10 13:40:00', 'Cash Deposit', 'credit', 'via_employee'),
...
(8, 750.00, '2023-08-01 09:00:00', 'ATM Fee', 'debit', 'atm-cdm'),
(8, 500.00, '2023-08-07 12:00:00', 'Salary Credit', 'credit', 'server'),
(9, 3000.00, '2023-09-01 08:45:00', 'Insurance Payment', 'debit', 'via_employee'),
(9, 450.00, '2023-09-05 11:15:00', 'Deposit via Employee', 'credit', 'via_employee'),
(10, 2000.00, '2023-10-03 16:30:00', 'Utility Payment', 'debit', 'server'),
(10, 300.00, '2023-10-10 09:45:00', 'Cash Deposit', 'credit', 'atm-cdm'),
(1, 1000.00, '2023-11-03 07:50:00', 'Mobile Bill', 'debit', 'via_employee'),
...
(2, 1050.00, '2023-11-25 14:30:00', 'Interest Payment', 'credit', 'server'),
(3, 400.00, '2023-12-01 09:15:00', 'Shopping', 'debit', 'online-transfer'),
(3, 3000.00, '2023-12-07 11:35:00', 'Deposit by Employee', 'credit', 'via_employee'),
(4, 1000.00, '2023-12-10 13:50:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(4, 2000.00, '2023-12-15 16:10:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(5, 2500.00, '2023-12-18 09:00:00', 'Loan Repayment', 'debit', 'server'),
(6, 3500.00, '2023-12-25 15:00:00', 'Interest Credit', 'credit', 'server');
...
(1, 1000.00, '2024-01-05 14:30:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(1, 250.00, '2024-01-12 09:45:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(1, 3000.00, '2024-01-15 16:20:00', 'Shopping', 'debit', 'via_employee'),
(1, 2000.00, '2024-01-20 11:00:00', 'Cashback', 'credit', 'server'),
(2, 300.00, '2024-02-02 12:30:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(2, 1000.00, '2024-02-10 10:45:00', 'Fund Transfer Fee', 'debit', 'server'),
(2, 500.00, '2024-02-15 14:00:00', 'Bonus Credit', 'debit', 'online-transfer'),
(2, 2500.00, '2024-02-20 09:30:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(3, 2000.00, '2024-03-01 08:10:00', 'Invoice Payment', 'debit', 'online-transfer'),
(3, 3050.00, '2024-03-05 15:25:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(3, 750.00, '2024-03-12 09:15:00', 'Deposit by Check', 'debit', 'via_employee'),
(3, 4000.00, '2024-03-18 12:45:00', 'Online Purchase', 'debit', 'via_employee'),
(3, 6000.00, '2024-03-20 17:10:00', 'Salary Adjustment', 'debit', 'online-transfer'),
...
(5, 2000.00, '2024-05-02 13:45:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(5, 300.00, '2024-05-05 09:30:00', 'Deposit from Client', 'credit', 'via_employee'),
(5, 4000.00, '2024-05-10 15:20:00', 'Online Shopping', 'debit', 'via_employee'),
(5, 5000.00, '2024-05-12 17:00:00', 'Transfer from Account', 'debit', 'online-transfer'),
(6, 2000.00, '2024-06-03 16:35:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(6, 1500.00, '2024-06-07 08:50:00', 'Electric Bill', 'debit', 'via_employee'),
(6, 300.00, '2024-06-12 14:45:00', 'Grocery Shopping', 'debit', 'via_employee'),
(6, 4000.00, '2024-06-18 10:30:00', 'Loan Repayment', 'debit', 'server'),
(1, 2000.00, '2024-07-01 09:15:00', 'Business Payment', 'credit', 'via_employee'),
(1, 3500.00, '2024-07-03 12:40:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(1, 6000.00, '2024-07-07 16:15:00', 'Deposit via Employee', 'credit', 'via_employee'),
(1, 500.00, '2024-07-12 08:50:00', 'Loan Repayment', 'debit', 'server'),
(1, 700.00, '2024-07-15 17:10:00', 'Cheque Deposit', 'credit', 'via_employee'),
(2, 1500.00, '2024-08-02 10:35:00', 'Mobile Bill', 'debit', 'via_employee'),
(2, 2000.00, '2024-08-05 13:25:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(2, 350.00, '2024-08-10 11:15:00', 'Groceries', 'debit', 'via_employee'),
(2, 6000.00, '2024-08-20 09:45:00', 'Account Adjustment', 'credit', 'server'),
(2, 10000.00, '2024-09-01 12:00:00', 'Investment Return', 'debit', 'atm-cdm'),
(3, 250.00, '2024-09-03 14:20:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(3, 500.00, '2024-09-07 08:15:00', 'Cash Deposit', 'credit', 'via_employee'),
(3, 1500.00, '2024-09-10 16:40:00', 'Credit Card Payment', 'debit', 'via_employee'),
(3, 2000.00, '2024-09-12 10:05:00', 'Loan Interest', 'debit', 'server'),
(4, 2200.00, '2024-10-01 15:00:00', 'Insurance Claim', 'credit', 'online-transfer'),
(5, 1000.00, '2024-10-03 09:45:00', 'ATM Withdrawal', 'debit', 'atm-cdm'),
(6, 3000.00, '2024-10-08 11:30:00', 'Utility Bill Payment', 'debit', 'via_employee'),
(5, 1500.00, '2024-10-10 08:30:00', 'CDM Deposit', 'credit', 'atm-cdm'),
(1, 5000.00, '2024-10-12 14:45:00', 'Bonus Credit', 'credit', 'server');
...
(11, '2024-06-30', 'approved', 'Purchase of equipments');
...
(1, 1, 2500.00, '2024-02-10', 'late', '2024-02-08'),
(1, 2, 2500.00, '2024-03-10', 'late', '2024-03-09'),
(1, 3, 2500.00, '2024-04-10', 'late', '2024-04-15'),
(1, 4, 2500.00, '2024-05-10', 'paid', '2024-05-09'),
(1, 5, 2500.00, '2024-06-10', 'pending', NULL),
(1, 6, 2500.00, '2024-07-10', 'pending', NULL),
(2, 1, 16666.67, '2024-03-15', 'late', '2024-03-14'),
...
(3, 2, 41666.67, '2024-05-05', 'late', '2024-05-03'),
...
(4, 2, 20000.00, '2024-06-10', 'late', '2024-06-08'),
...
(11, 1, 2000.00, '2024-06-20', 'paid', '2024-06-19'),
(11, 2, 2000.00, '2024-07-20', 'late', '2024-07-18'),
(11, 3, 2000.00, '2024-08-20', 'late', '2024-08-25'),
(11, 4, 2000.00, '2024-09-20', 'pending', NULL),
(11, 5, 2000.00, '2024-10-20', 'pending', NULL),
(11, 6, 2000.00, '2024-11-20', 'pending', NULL),
...
(9, 3, 45000.00, '2024-12-15', 'pending', NULL),
